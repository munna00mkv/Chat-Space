    ...
    public void onBindViewHolder(@NonNull MessageViewHolder messageViewHolder, int position) {
        ...
        if(fromMessageType.equals("text")){
            ...
            if(fromUserId.equals(messageSenderId)){
                messageViewHolder.messageSenderPicture.setVisibility(View.VISIBLE);
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/chat-space-dc669.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=6be6fdda-7fa1-494f-aa3f-bc5aa42e087e")
                            ...
                            public void onClick(DialogInterface dialogInterface, int position) {
                                if(position == 0){
                                    ...
                                    messageViewHolder.itemView.getContext().startActivity(intent);
                                     ...
                                     intent.putExtra("Uri",userMessagesList.get(position).getMessage());
                                     messageViewHolder.itemView.getContext().startActivity(intent);
